    ...
    <footer className="bg-white border-t border-gray-50 mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-text-dark mb-6">Pocopan Jugueteria®</h3>
        ...
        <div className="border-t border-gray-50 mt-16 pt-8 text-center">
          <p className="text-text-gray text-xs font-light tracking-widest uppercase tracking-tighter">&copy; 2025 Pocopan Jugueteria®. Todos los derechos reservados.</p>
